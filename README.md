...
The preview site is the [`Svlete-symbols`](https://svelte-symbols.jhairparis.com) website, built in [SvelteKit](https://kit.svelte.dev/).
...
> This project is inspired by [React-icons](https://react-icons.github.io/react-icons/) version 4.7.1
